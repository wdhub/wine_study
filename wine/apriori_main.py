...
#split words and prices in comments
def splitting (notes, prices):
    n = str(notes).split()
    #print (n[0])
    p = str(prices).split()
    #print(p[0])
...
rule = apriori(splitting, min_support = 0.003, min_confidence = 0.2, min_lift = 3, min_length = 2, max_length = 2)
